...
const Footer = () => {
    ...
    return (
        <footer className="relative overflow-hidden pt-24 pb-10 bg-[#030303]" style={{
            ...
            {/* Halftone Dots - Left Edge (Rich & Structured for Mobile & Desktop) */}
            <div className="absolute left-[-30px] top-[-20px] w-[320px] h-[400px] opacity-75 pointer-events-none max-md:w-[240px] max-md:h-[300px] max-md:opacity-65" style={{
                backgroundImage: 'radial-gradient(circle, rgba(255, 95, 0, 0.95) 1.5px, transparent 2.2px)',
                backgroundSize: '12px 12px',
                WebkitMaskImage: 'radial-gradient(ellipse at left top, black 0%, black 35%, rgba(0,0,0,0.6) 55%, transparent 82%)',
                maskImage: 'radial-gradient(ellipse at left top, black 0%, black 35%, rgba(0,0,0,0.6) 55%, transparent 82%)',
            }} />

            {/* Halftone Dots - Right Edge (Rich & Structured for Mobile & Desktop) */}
            <div className="absolute right-[-40px] top-[-10px] w-[400px] h-[520px] opacity-65 pointer-events-none max-md:w-[260px] max-md:h-[320px] max-md:opacity-55" style={{
                backgroundImage: 'radial-gradient(circle, rgba(255, 117, 30, 0.9) 1.6px, transparent 2.5px)',
                backgroundSize: '13px 13px',
                WebkitMaskImage: 'radial-gradient(ellipse at right top, black 0%, black 28%, rgba(0,0,0,0.5) 50%, transparent 78%)',
                maskImage: 'radial-gradient(ellipse at right top, black 0%, black 28%, rgba(0,0,0,0.5) 50%, transparent 78%)',
            }} />

            {/* Footer Structured Accent Dot Grid Pattern */}
            <div
                className="absolute inset-0 pointer-events-none opacity-35 md:opacity-45"
                style={{
                    backgroundImage: 'radial-gradient(circle, rgba(244, 117, 30, 0.35) 1.3px, transparent 1.3px)',
                    backgroundSize: '24px 24px',
                    backgroundPosition: '0 0',
                    WebkitMaskImage: 'radial-gradient(ellipse at center, black 30%, transparent 92%)',
                    maskImage: 'radial-gradient(ellipse at center, black 30%, transparent 92%)'
                }}
            />
                    ...
                    <div className="md:col-span-5 flex flex-col">
                        ...
                        <div className="flex flex-col gap-3.5 mb-8">
                            <div className="flex items-center gap-3 text-white/70 text-sm">
                                <MapPin className="w-4 h-4 text-[#F4751E] shrink-0" />
                                <span>Hyderabad, Telangana, India</span>
                            </div>
                            <div className="flex items-center gap-3 text-white/70 text-sm">
                                <Phone className="w-4 h-4 text-[#F4751E] shrink-0" />
                                <a href="tel:+919398404167" className="hover:text-[#F4751E] transition-colors focus-visible:outline-none focus-visible:underline">
                                    +91 93984 04167
                                </a>
                            </div>
                            <div className="flex items-center gap-3 text-white/70 text-sm">
                                <Mail className="w-4 h-4 text-[#F4751E] shrink-0" />
                                <a href="mailto:continentalgrandtechnologies@gmail.com" className="hover:text-[#F4751E] transition-colors break-all focus-visible:outline-none focus-visible:underline">
                                    continentalgrandtechnologies@gmail.com
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            <a href="https://www.linkedin.com/company/continental-grand-technologies" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white/[0.04] border border-white/10 text-white/60 hover:text-[#F4751E] hover:border-[#F4751E]/40 transition-colors duration-300 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="LinkedIn">
                            ...
                            <a href="https://x.com/CGT_OFFICIAI_" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white/[0.04] border border-white/10 text-white/60 hover:text-[#F4751E] hover:border-[#F4751E]/40 transition-colors duration-300 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="X (Twitter)">
                            ...
                            <a href="https://www.instagram.com/continentalgrandtechnologies/" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white/[0.04] border border-white/10 text-white/60 hover:text-[#F4751E] hover:border-[#F4751E]/40 transition-colors duration-300 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="Instagram">
                            ...
                            <a href="https://github.com/continental-grand-technologies" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white/[0.04] border border-white/10 text-white/60 hover:text-[#F4751E] hover:border-[#F4751E]/40 transition-colors duration-300 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="GitHub">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                            </a>
                            <a href="https://wa.me/919398404167" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white/[0.04] border border-white/10 text-white/60 hover:text-[#F4751E] hover:border-[#F4751E]/40 transition-colors duration-300 min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="WhatsApp">
