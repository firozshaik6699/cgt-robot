                                ...
                                <Reveal key={step.number} delay={0.2} direction={isEven ? 'right' : 'left'}>
                                    <div className={`flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16 ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                                        ...
                                        <div className={`flex-1 w-full md:w-1/2 ${isEven ? 'md:text-right' : 'md:text-left'} pl-16 md:pl-0`}>
                                            <div className="group relative overflow-hidden rounded-[2rem] border border-white/[0.06] bg-[#0a0a0a] p-8 md:p-10 transition-colors duration-500 hover:border-[#F4751E]/30 shadow-[0_15px_40px_rgba(0,0,0,0.4)]">
                                                
                                                {/* Background Image Layer */}
                                                {step.image && (
                                                    <div 
                                                        className="absolute inset-0 z-0 opacity-10 transition-[transform,opacity] duration-700 group-hover:opacity-20 group-hover:scale-105 will-change-transform"
                                                        style={{
                                                ...
                                                <div className="absolute inset-0 bg-gradient-to-br from-[#F4751E]/[0.08] to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100 z-0" />
                                        ...
                                        {/* Timeline Orb */}
                                        <div className="absolute left-[28px] md:relative md:left-0 -translate-x-1/2 md:translate-x-0 w-14 h-14 md:w-16 md:h-16 rounded-full border border-white/[0.1] bg-[#111] flex items-center justify-center flex-shrink-0 z-20 group transition-[transform,border-color,box-shadow] duration-500 hover:border-[#F4751E]/60 hover:shadow-[0_0_35px_rgba(244,117,30,0.4)] hover:scale-110 mt-2 md:mt-0 cursor-default will-change-transform">
