  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        {/* Halftone Dot Texture - Left Edge (Structured & Pixel-Perfect on Mobile) */}
        <div
          className="absolute left-[-40px] top-[-30px] w-[420px] h-[520px] opacity-100 max-md:left-[-15px] max-md:top-[-10px] max-md:w-[200px] max-md:h-[240px] max-md:opacity-35"
          style={{
            backgroundImage: 'radial-gradient(circle, rgba(255, 83, 0, 0.9) 1.5px, transparent 2.2px)',
            backgroundSize: '12px 12px',
            WebkitMaskImage: 'radial-gradient(circle at top left, black 0%, black 35%, transparent 75%)',
            maskImage: 'radial-gradient(circle at top left, black 0%, black 35%, transparent 75%)',
        ...
        {/* Halftone Dot Texture - Right Edge (Structured & Pixel-Perfect on Mobile) */}
        <div
          className="absolute right-[-60px] top-[-20px] w-[540px] h-[780px] opacity-80 max-md:right-[-15px] max-md:top-[-10px] max-md:w-[200px] max-md:h-[260px] max-md:opacity-30"
          style={{
            backgroundImage: 'radial-gradient(circle, rgba(255, 94, 0, 0.85) 1.5px, transparent 2.5px)',
            backgroundSize: '13px 13px',
            WebkitMaskImage: 'radial-gradient(circle at top right, black 0%, black 35%, transparent 75%)',
            maskImage: 'radial-gradient(circle at top right, black 0%, black 35%, transparent 75%)',
