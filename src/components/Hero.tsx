            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center relative z-10 pointer-events-none">
                ...
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-[55%] z-10 p-4 pointer-events-none pt-8 lg:pt-16">
                    ...
                    <motion.div
                        ...
                        className="px-3 md:px-4 py-1.5 mb-6 md:mb-10 flex items-center gap-2 md:gap-3 z-10 border border-white/[0.06] bg-[#0a0a0a]/90 rounded-full"
                    >
                    ...
                    >
                        <h1 className="text-[2.25rem] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[5rem] font-extrabold tracking-[-0.04em] mb-4 md:mb-6 text-white leading-[1.05] md:leading-[0.95] pointer-events-auto">
                        ...
                        <div className="overflow-hidden mt-2 pointer-events-none">
                            <motion.p
                                ...
                                className="text-sm sm:text-base md:text-lg text-white/50 max-w-lg mx-auto lg:mx-0 leading-relaxed font-light pointer-events-auto px-2 lg:px-0"
                            >
                    ...
                    >
                        <div className="flex items-center gap-1.5 md:gap-2 bg-[#111] md:bg-transparent px-3 py-1.5 md:p-0 rounded-full md:rounded-none border border-white/5 md:border-transparent">
