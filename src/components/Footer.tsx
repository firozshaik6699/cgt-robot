                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-20">
                    ...
                    <div className="md:col-span-5 flex flex-col">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <a href="https://x.com/caborobotics" target="_blank" rel="noopener noreferrer" className="text-white/38 hover:text-[#F4751E]/75 transition-colors duration-300" aria-label="Twitter">
